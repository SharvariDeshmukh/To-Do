...
class Account{
    ...
    public function register($fn,$un,$em,$em2,$pw,$pw2){
    ...
    public function insertUserDetails($fn,$un,$em,$pw ){
    $pw=hash("sha512",$pw);
   

    $query=$this->con->prepare("INSERT INTO users (firstName, username,email,password)
                                VALUES(:fn, :un, :em, :pw)");
